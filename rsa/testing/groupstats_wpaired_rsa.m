...
% run paired t-test for task fmri/glm analysis and
% RSA

% -------------------------------------------------------------------------

%% toolboxes and env set up
Config_File='/oak/stanford/groups/menon/projects/daelsaid/2019_mathfun/scripts/config_scripts/md_pre_vs_post_dot_vs_num_rsa_groupstats_config_swgcar.m';

% function groupstats_wpaired_rsa(Config_File)

addpath(genpath('/oak/stanford/groups/menon/projects/shelbyka/2017_TD_MD_mathfun/results/taskfmri/groupstats/rsa'));
addpath(genpath('/oak/stanford/groups/menon/projects/daelsaid/2019_mathfun'));

% Config_File='/oak/stanford/groups/menon/projects/daelsaid/2019_mathfun/scripts/config_scripts/groupstats_rsa_config_yz.m';
...
software_path           = '/Users/daelsaid/tools/spm12';
